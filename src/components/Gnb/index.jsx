...
const Gnb = ({
  ...
  const isInterest = flow(
    replace(/\/$/, ''),
    isEqual('/interest')
  )(pathname);
  const isPost = !(isPortfolio || isHome || isResume || isInterest);
  ...
  return (
    <GnbWrapper>
      <MobileMenu isActive={isMenuOpened} isSubActive={isSubMenuOpened}>
        ...
        <MobileMenus>
          <ul>
            ...
            <ListMenu>
              <StyledLink to="/interest" className={isResume ? 'active' : ''} onClick={closeMenu}>
                Resume
              </StyledLink>
            </ListMenu>
            <SearchBarWrapper>
      ...
      <ul>
        ...
        <ListMenu>
          <StyledLink to="/interest" className={isResume ? 'active' : ''}>
            Interest
          </StyledLink>
        </ListMenu>
        <SearchBarWrapper>
